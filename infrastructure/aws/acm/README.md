...
Creates and validates an AWS ACM wildcard certificate using DNS validation with Route53
...
```hcl
module "acm" {
  source = "git::https://github.com/nullplatform/tofu-modules.git//infrastructure/aws/acm?ref=v1.36.0"
