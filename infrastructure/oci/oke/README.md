...
```hcl
module "oke" {
  source = "git::https://github.com/nullplatform/tofu-modules.git//infrastructure/oci/oke?ref=v6.11.3"
...
| Name | Version |
|------|---------|
| <a name="provider_oci.home"></a> [oci.home](#provider\_oci.home) | 7.29.0 |
