...
- Manages resource tagging for all created resources
...
```hcl
module "private_dns" {
  source = "git::https://github.com/nullplatform/tofu-modules.git//infrastructure/azure/private_dns?ref=v1.38.1"
