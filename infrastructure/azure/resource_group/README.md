...
- Enforces Terraform version constraint of 1.6 or higher

## Basic Usage

```hcl
module "resource_group" {
  source = "git::https://github.com/nullplatform/tofu-modules.git//infrastructure/azure/resource_group?ref=v1.39.0"
