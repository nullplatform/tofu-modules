...
- Outputs resource group name and location for reference by other modules
- Requires Terraform version 1.6 or higher and azurerm provider version 4.0 or higher

## Basic Usage

```hcl
module "resource_group" {
  source = "git::https://github.com/nullplatform/tofu-modules.git//infrastructure/azure/resource_group?ref=v1.38.3"
