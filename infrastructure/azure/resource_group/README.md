...
Creates an Azure Resource Group with configurable tags and outputs its name and location
...
- Outputs the resource group name and location for use by other modules
- Configures Azure provider with CLI authentication
- Requires Terraform version 1.6 or higher

## Basic Usage

```hcl
module "resource_group" {
  source = "git::https://github.com/nullplatform/tofu-modules.git//infrastructure/azure/resource_group?ref=v1.38.2"
