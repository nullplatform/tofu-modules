...
- Configures the DNS zone within a specified resource group
...
- Manages DNS zone lifecycle through Terraform

## Basic Usage

```hcl
module "dns" {
  source = "git::https://github.com/nullplatform/tofu-modules.git//infrastructure/azure/dns?ref=v1.38.0"
