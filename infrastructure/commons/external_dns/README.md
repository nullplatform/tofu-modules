...
| <a name="input_oci_region"></a> [oci\_region](#input\_oci\_region) | The OCI region where the DNS zones are located (required when dns\_provider\_name is 'oci') | `string` | `null` | no |
