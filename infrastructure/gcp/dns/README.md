...
- Manages DNS zone naming with automatic sanitization from domain names
- Applies custom labels and tags to DNS zones
- Outputs zone details including name servers for delegation

## Basic Usage

```hcl
module "dns" {
  source = "git::https://github.com/nullplatform/tofu-modules.git//infrastructure/gcp/dns?ref=v1.41.0"
