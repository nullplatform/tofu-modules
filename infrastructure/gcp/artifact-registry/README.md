...
- Provisions a dedicated service account for artifact operations
...
```hcl
module "artifact-registry" {
  source = "git::https://github.com/nullplatform/tofu-modules.git//infrastructure/gcp/artifact-registry?ref=v1.38.0"
