...
- Configures private zone VPC network associations
- Manages DNS zone resource naming
...
```hcl
module "cloud-dns" {
  source = "git::https://github.com/nullplatform/tofu-modules.git//infrastructure/gcp/cloud-dns?ref=v1.38.2"
