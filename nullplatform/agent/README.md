...
| <a name="input_istio_blue_green_ingress_path"></a> [istio\_blue\_green\_ingress\_path](#input\_istio\_blue\_green\_ingress\_path) | Path, inside the worker image, of the HTTPRoute template used to shift traffic during a blue-green deployment, used when worker\_ingress is "istio". | `string` | `"/home/agent/.np/nullplatform/scopes/k8s/deployment/templates/istio/blue-green-httproute.yaml.tpl"` | no |
| <a name="input_istio_initial_ingress_path"></a> [istio\_initial\_ingress\_path](#input\_istio\_initial\_ingress\_path) | Path, inside the worker image, of the HTTPRoute template for a scope's first deployment, used when worker\_ingress is "istio". | `string` | `"/home/agent/.np/nullplatform/scopes/k8s/deployment/templates/istio/initial-httproute.yaml.tpl"` | no |
| <a name="input_istio_service_template"></a> [istio\_service\_template](#input\_istio\_service\_template) | Path, inside the worker image, of the Service template used when worker\_ingress is "istio". | `string` | `"/home/agent/.np/nullplatform/scopes/k8s/deployment/templates/istio/service.yaml.tpl"` | no |
