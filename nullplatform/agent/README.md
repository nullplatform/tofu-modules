...
| <a name="input_aws_iam_role_arn"></a> [aws\_iam\_role\_arn](#input\_aws\_iam\_role\_arn) | ARN of the AWS IAM role assigned to the agent | `string` | `null` | no |
...
| <a name="input_np_api_key"></a> [np\_api\_key](#input\_np\_api\_key) | API key used to authenticate with the nullplatform API | `string` | n/a | yes |
