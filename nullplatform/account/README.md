...
- Supports custom slug assignment per account
- Manages accounts through the Nullplatform provider
...
```hcl
module "account" {
  source = "git::https://github.com/nullplatform/tofu-modules.git//nullplatform/account?ref=v1.38.2"
